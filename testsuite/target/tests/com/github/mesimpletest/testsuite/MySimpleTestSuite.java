...
public class MySimpleTestSuite extends J2meBaseTestSuite {
    ...
    public InterviewParameters createInterview() throws Fault {
        try {
            ...
            return BasicTckInterview.createBuilder(this)//.setImpAware(false)
                .setSubInterview("com.oracle.simpletest.MySimpleTestInterview").setDistributed(true)
                .setBundleSizeLimit(100000).setKeywordsEnabled(true)
                .setEnableSeparatorQuestion(true).setImplemetationBaseChoices(new String[] {VmInterview.MIDP})
                .build();
